...
const Experience = () => (
    <section id="experience" className="gap-5 w-[64rem] flex-col flex self-center h-screen justify-center">
        <h2 className="uppercase tracking-widest text-3xl before:bg-amber-400 before:h-px before:block before:w-16 before:my-6 before:absolute before:mt-12 after:w-1.5 after:h-1.5 after:rounded-full after:absolute after:bg-amber-400 after:my-[45px] after:mr-0 after:mx-[-10rem] mb-16">Experience.</h2>
        {experienceSet.map((experience) => (
            <div key={experience.companyName} >
                <div className='flex w-[64rem] bg-slate-800 h-52 gap-10 items-center'>
                    <div>
